...
public:
  ...
  Int   m_statsInterval;       ///< if so, how many is N?
	...
	Bool m_lanListGames;							///< -lanlist: ask the relay what games exist, print them, exit
	Bool m_lanOverfill;								///< -lanoverfill: allow more players than the map has start positions
